...
<head>
    ...
    <script src="../js/reportesA/loadDataPanel.js"></script>
    <script src="../js/reportesA/loadDataTableReports.js"></script>
    <script src="../js/reportesA/loadBarChart.js"></script>
    <script src="../js/reportesA/loadPieChart.js"></script>
    <script src="../js/reportesA/loadLineChart.js"></script>
        ...
        <div class="boxed">
          ...
          <div id="content-container">
              <div id="page-head">
                  ...
                  <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                  <div id="page-title">
                      <h1 class="page-header text-overflow">Reporte Histórico</h1>
