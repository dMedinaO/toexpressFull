...
<head>
    ...
    <script src="../js/reportesD/loadBarChart.js"></script>
    <script src="../js/reportesD/loadDataPanel.js"></script>
    <script src="../js/reportesD/loadDataTableReports.js"></script>
    <script src="../js/reportesD/loadPieChart.js"></script>
        ...
        <div class="boxed">
          ...
          <div id="content-container">
              <div id="page-head">
                  ...
                  <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                  <div id="page-title">
                      <h1 class="page-header text-overflow">Reporte Diario</h1>
                  ...
                  <div class="col-sm-6 col-md-6 col-lg-6">
                    <div class="panel">
                      <div class="panel-heading">
                        <h3 class="panel-title">Documentos por estado</h3>
                      </div>
