        ...
        <div class="boxed">
          ...
          <div id="content-container">
              <div id="page-head">
                  ...
                  <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                  <div id="page-title">
                      <h1 class="page-header text-overflow">Sistema de Notificaciones</h1>
                  ...
                  <div class="col-sm-12 col-md-12 col-lg-12">
                    <div class="panel">
                      ...
                      <div class="panel-body">
                        <form method="post" action="service.php" class="form-horizontal form-label-left" name="notification">

                          <div class="form-group">

                            <label class="col-sm-3 control-label" for="notification-title-input">Titulo de la notificación</label>

                              <div class="col-sm-5">
                                <input id="notification-title-input" type="text" name="notification_title" class="form-control">
                              </div>
                          </div>

                          <div class="form-group">
                            <label for="notification-body-input" class="col-sm-3 control-label">Cuerpo de la notificación</label>

                              <div class="col-sm-5">
                                <textarea id="notification-body-input" type="text" name="notification_body" class="form-control">
                                </textarea>
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                            <div class="col-sm-5 col-sm-offset-3">
                              <input type="submit" class="btn btn-primary" value="Enviar notificación">
