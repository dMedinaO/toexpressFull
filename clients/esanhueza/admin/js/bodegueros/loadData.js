...
$(window).on('load', function() {
    ...
    //listamos los datos...
	    ...
	    var t = $('#bodegaData').DataTable({
	        ...
	        "dom": '<"newtoolbar">frtip',
					...
					"ajax":{
						"method":"POST",
						"url": "../php/bodegueros/showData.php"
					},

					"columns":[
						{"data":"nombreBodeguero"},
						{"data":"nombre"},
						{"data":"nameUser"},
						{"data":"password"},
						{"data":"email"},
						{"data":"numberDevice"},
						{"data":"createdBodeguero"},
						{"data":"modifiedBodeguero"},
	...
	var obtener_id_eliminar = function(tbody, table){
		$(tbody).on("click", "button.eliminar", function(){
			...
			var iduser = $("#frmEliminar #iduser").val( data.idbodeguero );
		});
	}
	...
	var obtener_data_editar = function(tbody, table){
		$(tbody).on("click", "button.editar", function(){
			var data = table.row( $(this).parents("tr") ).data();
			var idbodeguero = $("#frmEditar #iduser").val( data.idbodeguero);
			var name = $("#frmEditar #name").val(data.nombreBodeguero);
	...
	var eliminar = function(){
		$("#eliminar-usuario").on("click", function(){
			...
			$.ajax({
				method:"POST",
				url: "../php/bodegueros/removeData.php",
				data: {
						"iduser": iduser
					  }
			}).done( function( info ){
	...
	var guardar = function(){
		$("#agregar-bodega").on("click", function(){
			...
			var bodega = $("#frmAgregar #bodega").val();

			$.ajax({
				method: "POST",
				url: "../php/bodegueros/addData.php",
				data: {
						"name"   : name,
						"username"   : username,
						"phone" : phone,
